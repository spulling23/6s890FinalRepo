...
DATA_FOLDER = "/Users/zackduitz/Desktop/organized/MIT/MIT_5th_year_classes/multi-agent_learning/final_project/pgn_files" # folder containing the data files
inter = os.path.join(DATA_FOLDER, NAME)
# H5_FILE = NAME + ".h5"  # H5 file containing data
H5_FILE = inter + ".h5"  # H5 file containing data
