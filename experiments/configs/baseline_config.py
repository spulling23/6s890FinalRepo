...
H5_FILE = "mixed_skill_10k.h5"  # 10K games for small-scale test
...
VOCAB_SIZES = {
    "moves": 1968,  # All possible UCI moves
    ...
    "board_position": 13,  # Empty + 6 piece types × 2 colors
}
...
BATCHES_PER_STEP = 4
PRINT_FREQUENCY = 10
N_STEPS = 1000  # Small-scale: 1K steps
WARMUP_STEPS = 100
LR_SCHEDULE = "vaswani"
LR_DECAY = None
