"""
Expert Configuration - Standard Training (2000 steps)

Quick training run on expert dataset with standard cross-entropy loss.
"""

import pathlib

# Experiment name
NAME = "expert_standard_2k"
...
# Standard training - no regularization
