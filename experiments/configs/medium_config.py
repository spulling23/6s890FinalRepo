"""
Medium Skill Configuration

This configuration uses a medium-skill dataset (intermediate ELO range)
to train a model on mid-level chess play.
"""
...
# Dataset file
H5_FILE = "med_chunks_combined.h5"
...
# No game-theoretic regularization for medium baseline
